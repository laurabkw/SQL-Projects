...
CREATE OR REPLACE VIEW cliente_pedido AS
SELECT *
FROM cliente
WHERE cod_profissao IS NOT NULL;

ALTER VIEW cliente_pedido AS
SELECT *
FROM pedido;
...
DROP VIEW cliente_pedido;

SELECT *
FROM cliente
WHERE nome_cliente LIKE '%Pereira%';